...
you know, an *RMarkdown* document lets you can mix text, R code, and the output of that R
code.
...
::: {.more}
HTML is probably the most convenient and easy to use output format. If you wnat to use PDF
or Word, you will have to worry about page sizes and page breaks. It's best to avoid this
until later in the process. For PDF in particular, wou will also have to install a
...
person would wnat to read, or a journal would be willing to accept?
