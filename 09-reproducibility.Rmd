...
Version control is like a time machine for your analysis. It is to code what the 💾is to a
Word document (but better). A popular version control tool is [Git](https://git-scm.com/).
Git allows you to...
