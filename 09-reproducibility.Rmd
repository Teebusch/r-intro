...
All the steps in your analysis are visible in your script files. While GUI-based workflows
are not reproducible, well-written code provides documentation and data provenance.
However, you have to make sure your code keeps doing what it does today! R can help you
with that in a number of ways!
...
You can take this idea a step further by using [Docker with
Rocker](https://www.rocker-project.org/) - fully reproducible data analysis in a Docker
container (virtual machine).

## Use version control

Version control is like a time machine for your analysis. It is to code what the
:floppy_disk: is to a Word document (but better). A popular version control tool is
[Git](https://git-scm.com/). Git allows you to...
...
For maximum reproducibility you could install Docker, so that you can create an RStudio
[Docker container](https://www.rocker-project.org/) for each project, but that is beyond
...
PDF, a Word file) that you can share with others.
...
-   Test-driven development with `{testthat}, {tinytest}. {testrmd}`
...
you can already rest assured, that you can alway go back and see the changes you have
