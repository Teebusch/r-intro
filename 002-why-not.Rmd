...
Getting there can---at times---be frustrating. This investment of time and cognitive
energy may never pay off if you only do a small analysis every once in a while or if your
current workflow already works well for you.

[^why-not-1]: Even if you already know another programming language, R can be a little
    weird. For examples of R's weirdness, I recommend John Cook's talk [*The R Language
...
Others are comprehensive user interfaces for data analysis who's functionality rivals that
of costly software like SPSS. [Jamovi](https://www.jamovi.org/) and
[JASP](https://jasp-stats.org/), for example, are graphical user interfaces built that are
built on top of R and allow you to utilize much of R's power without writing any R code.
...
statistical tests and models, they provide excellent customer support and a single,
well-documented way to solve a certain type of problem. In contrast, R usually offers a
multitude of ways to reach the same goal. While this allows you to choose the tools that
suit your needs, this choice can be difficult. Consequently, R requires a more thorough
