...
+-------------------------+--------------------------------------------------------------+
| `pivot_wider()` and     | Reshape the data between long and wide format                |
| `pivot_longer()`        |                                                              |
+-------------------------+--------------------------------------------------------------+
| `left_join()`,          | Join observations from multiple data frames                  |
| `right_join()`,         |                                                              |
| `inner_join()`,         |                                                              |
| `full_join()`           |                                                              |
+-------------------------+--------------------------------------------------------------+
| `bind_cols()`,          | Combining multiple data frames into one, either by adding    |
| `bind_rows()`           | additional columns or additional rows                        |
+-------------------------+--------------------------------------------------------------+
...
You can read `%>%` as *"...and then..."*. Use the keyboard shortcut <kbd>Ctrl</kbd> +
<kbd>Shift</kbd> + <kbd>M</kbd> to make it.
