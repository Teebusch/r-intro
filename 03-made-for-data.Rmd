...
Often you will get a data frame by reading in a tabular data file like a spreadsheet but
you can also make a data frame yourself, by combining vectors with the `data.frame()`
function:
