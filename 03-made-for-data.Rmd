...
::: {.goals}
-   What are the most important data types and data structures in R?
-   How can you assign data to variables?
-   How to write comments in R?
-   What are the important properties of vectors?
-   How can you access specific elements of a vector?
-   What are data frames shaped like?
:::
...
*Advanced R,* chapters 2-4
([\<https://adv-r.hadley.nz/vectors-chap.html\>](https://adv-r.hadley.nz/vectors-chap.html)).
These provide a much more thorough overview of R's data types and data structures.
:::
