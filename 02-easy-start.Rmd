...
account at *RStudio Cloud* (<https://rstudio.cloud/>). This allows you to use R and
...
things more comfortable. There are some alternatives to RStudio, but R's own GUI is not
really one of them:
...
new data analysis project with RStudio is to create a new **RStudio project**. This is the
first step towards reproducibility: All of your project's data and files will be stored in
the same folder. If you ever move this folder to a new location or share it with someone
else, all of the files will move along with it, reducing the chance that things will
break. Another benefit of using projects is that it helps you to keep your work organized.
It will be much easier for you to switch between projects or get back to a project you
