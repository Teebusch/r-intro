...
make an account at [rstudio.cloud](https://rstudio.cloud/) and use R and RStudio in the
browser. That's it! Everything else you need can be set up from within RStudio.
