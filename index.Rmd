...
to learn R and some worthwhile alternatives. Then we present ten reasons to learn R and
along with that, you will get some hands-on experience.

The book presents modern R, with *RStudio, RMarkdown*, and the *Tidyverse*. It focuses on
the parts that are most essential for reproducible data analysis and keeps the technical
details to a minimum. After reading it, you will know the basics of data analysis in R and
should be able to decide whether you want to continue learning.

::: {.draftinfo}
**This is a draft!** This book is a work in progress and nobody knows *if* and *when* it
will ever be finished.
:::

## Who is this for? {.unnumbered}

This book is written for someone who has some experience doing data analysis with other
tools but now wants to learn more about R. You are here, because you want to learn tools
that can help you get things done, and you wonder if R might be one of them. Your
motivation might be that...
...
group meeting at the University of Oslo's Department of Special Needs Education. It was a
90 minutes long hands-on introduction to R with the goal to provide an overview of R.
After the workshop, I continued to expand on the material and eventually, it turned into a
more comprehensive introduction to R.
...
Together*](https://teachtogether.tech/), but in contrast to a typical Carpentries lessons,
the book progresses faster and skips over some of the fundamentals. It provides a broader
overview of R at the expense of depth.
...
I am still considering which license is best for this. For the time being, the book is
published with all rights reserved by the author, Tobias Busch, and may not be reproduced
